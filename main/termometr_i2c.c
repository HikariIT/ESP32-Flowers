...
void app_main()
{
    ...
    while(1) {
        ...
        ESP_LOGI(TAG, "Temperature is %d C deg.", DHT11_read().temperature);
        ESP_LOGI(TAG, "Humidity is %d%%", DHT11_read().humidity);
        //printf("Status code is %d\n", DHT11_read().status);
        ESP_LOGI(TAG, "Refresh in %d seconds...", REFRESH_RATE/1000);
